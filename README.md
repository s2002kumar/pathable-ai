...
| Suite                                   | Count                                                           | Command                                                    |
| --------------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------- |
| Backend, unit + PostGIS integration     | **727 passed, 1 skipped**, 89.13% coverage against an 86% floor | `uv run pytest --cov=src/pathable_api --cov-fail-under=86` |
...
real browser through real containers. Eight of its tests need the real Waterloo network and
