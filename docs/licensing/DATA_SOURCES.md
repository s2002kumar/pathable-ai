...
| Volume and frequency           | Anonymous reads from Overture's public S3 bucket: 570.8 MB and 561.9 MB received in the two regional runs measured, 85% of it the bridge-file sample (per artifact in the extract manifests). No volume terms were found on the attribution page.                                                                                        |
