...
| ODbL compatibility             | **Not settled.** Three facts are kept apart. (1) The City's licence permits PathAble's present read-only research use. (2) The City has separately given explicit permission for its data to be incorporated into OpenStreetMap (wiki _Waterloo region/Kitchener authorization_, revision 2726386, 2024-07-03). (3) Formal approval of the Kitchener licence by the OSMF Licensing Working Group has **not been confirmed**. The OSMF's list of approved Canadian OGL variants (_OGL Canada and local variants_, revision 14791, 2026-09-14) names the Region of Waterloo, the City of Waterloo and the City of Cambridge, not Kitchener. A post on the OSM community forum (2026-08-28) reports a review request sent to the LWG on 2026-08-18 that had not been acknowledged. See the licensing gate below. |
...
| Founder approval               | Not required for the read-only research of PA-GEO-03 and PA-GEO-04: no cost, no credentials, and the City's licence covers it. **Required** before any Kitchener-derived assertion is incorporated into, or redistributed with, the production OSM-derived routing database: see the licensing gate below.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

**Licensing gate before production use.**
...
- Formal OSMF LWG approval of the Kitchener licence has not been confirmed.

This does not block PA-GEO-03 or PA-GEO-04. It does mean licence compatibility
must be reviewed again before any Kitchener-derived assertion is incorporated
into, or redistributed with, the production OSM-derived routing database — that
is, before any reconciliation card writes a Kitchener value where routing,
explanations or a published derived database can read it. That review is a
founder licensing decision, taken before such a card starts, not during it. This
records engineering understanding, not legal advice.
